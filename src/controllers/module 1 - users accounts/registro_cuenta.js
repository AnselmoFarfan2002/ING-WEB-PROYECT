...
controllers.REGISTRAR_CUENTA = (req, res) => {
    ...
    mysqlConnection.query(query, (err, rows, ifield)=>{
        let msg = ''; //Mensaje
        var i = 0; //Indice
        let validate = [ //Expresiones regulares para campos de registro
            ...
            /^[a-zA-ZÀ-ÿ\00f1\00d1]+(\s*[a-zA-ZÀ-ÿ\00f1\00d1]*)*[a-zA-ZÀ-ÿ\00f1\00d1]{4,20}$/, //Patron del rol de persona
