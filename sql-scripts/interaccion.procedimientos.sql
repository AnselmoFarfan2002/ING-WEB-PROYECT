...
create procedure get_inte_interacciones(idUsuario int unsigned) begin
	SELECT INT_CHAT AS idChat, INT_NOTIFICACION AS notificacion, CHAT_PUBLICACION AS idPublicacion, PUBLI_TITULO AS titulo, PUBLI_FOTOS AS fotos, CHAT_ULTIMA_ACTIVIDAD AS ultimaActividad, PUBLI_AUTOR AS idAutor
