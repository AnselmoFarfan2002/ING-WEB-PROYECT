...
create procedure post_usu_usuario( 
	...
	INSERT INTO USUARIO VALUES (USU_RUC, USU_ENTIDAD, USU_UBICACION, USU_ROL_ENTIDAD, USU_NOMBRE, USU_ROL_PERSONA, UPPER(USU_CORREO), USU_CELULAR, USU_TELEFONO, aes_encrypt(USU_CONTRASENIA, keyword) );
end$$
