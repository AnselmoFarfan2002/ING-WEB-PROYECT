...
create procedure get_usu_usuario( userId int unsigned ) begin
	SELECT USU_ID, EMP_UBICACION, EMP_ENTIDAD, USU_EMPRESA, USU_TELEFONO, USU_CELULAR, USU_NOMBRE, USU_APELLIDO1, USU_APELLIDO2, CAR_NOMBRE as USU_CARGO, USU_CORREO, USU_FOTO FROM USUARIO 
